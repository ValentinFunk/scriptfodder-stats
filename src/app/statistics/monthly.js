angular.module('stats').controller('MonthlyCtrl', function($scope, scripts) {
      ...
      .mapValues(function(script) {
        var scriptData = _(script.purchases)
          ...
          .groupBy(function(purchase) {
            return moment(purchase['purchase_time'] * 1000)
              .startOf(interval)
              .unix();
          })
          .tap(function(array) {
            for (
              var current = moment(earliest);
